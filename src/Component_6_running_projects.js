...
import { Row, Progress, Col, FormGroup, Input } from 'reactstrap'
  ...
  return (
    <div id='component_6_project'>
      ...
      <Row>
        <Col>
          <div>
            <a href='#' style={{ textDecoration: 'none' }}>
              <img src={Flogo} style={{ height: '30px', width: '30px' }} />
              Falcon{' '}
            </a>
            <a id='box'>{value1}%</a>
          </div>
        ...
        <Col>
          <Progress
            style={{ height: '20%', marginTop: '13px', width: '80px' }}
            value={10 * 3.8}
          />
        </Col>
      </Row>
